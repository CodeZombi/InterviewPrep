  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/30 backdrop-blur-sm">
      <div className="w-full max-w-lg bg-white p-6 rounded-xl shadow-xl animate-fade-in">
        {/* header */}
        <h2 className="text-2xl font-bold text-black-700 mb-4">{title}</h2>
        ...
        <button
          onClick={onClose}
          className="w-full bg-black hover:bg-black text-white font-semibold py-2.5 rounded-full transition"
        >
          Got it, begin
        </button>
      </div>
